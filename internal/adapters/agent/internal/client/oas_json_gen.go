...
// Encode implements json.Marshaler.
func (s *APIParsingBookCheckPostOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *APIParsingBookCheckPostOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("result")
		e.ArrStart()
...
var jsonFieldsNameOfAPIParsingBookCheckPostOK = [1]string{
	0: "result",
}

// Decode decodes APIParsingBookCheckPostOK from json.
func (s *APIParsingBookCheckPostOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode APIParsingBookCheckPostOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "result":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				s.Result = make([]APIParsingBookCheckPostOKResultItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem APIParsingBookCheckPostOKResultItem
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		return errors.Wrap(err, "decode APIParsingBookCheckPostOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAPIParsingBookCheckPostOK) {
					name = jsonFieldsNameOfAPIParsingBookCheckPostOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *APIParsingBookCheckPostOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *APIParsingBookCheckPostOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *APIParsingBookCheckPostOKResultItem) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *APIParsingBookCheckPostOKResultItem) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("url")
...
var jsonFieldsNameOfAPIParsingBookCheckPostOKResultItem = [4]string{
	0: "url",
	1: "result",
	2: "error_details",
...
// Decode decodes APIParsingBookCheckPostOKResultItem from json.
func (s *APIParsingBookCheckPostOKResultItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode APIParsingBookCheckPostOKResultItem to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode APIParsingBookCheckPostOKResultItem")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAPIParsingBookCheckPostOKResultItem) {
					name = jsonFieldsNameOfAPIParsingBookCheckPostOKResultItem[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *APIParsingBookCheckPostOKResultItem) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *APIParsingBookCheckPostOKResultItem) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes APIParsingBookCheckPostOKResultItemResult as json.
func (s APIParsingBookCheckPostOKResultItemResult) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes APIParsingBookCheckPostOKResultItemResult from json.
func (s *APIParsingBookCheckPostOKResultItemResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode APIParsingBookCheckPostOKResultItemResult to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch APIParsingBookCheckPostOKResultItemResult(v) {
	...
	default:
		*s = APIParsingBookCheckPostOKResultItemResult(v)
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s APIParsingBookCheckPostOKResultItemResult) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *APIParsingBookCheckPostOKResultItemResult) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode encodes APIParsingBookCheckPostReq as json.
func (o OptAPIParsingBookCheckPostReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes APIParsingBookCheckPostReq from json.
func (o *OptAPIParsingBookCheckPostReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptAPIParsingBookCheckPostReq to nil")
	}
	o.Set = true
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptAPIParsingBookCheckPostReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptAPIParsingBookCheckPostReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes APIParsingBookPostReq as json.
func (o OptAPIParsingBookPostReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes APIParsingBookPostReq from json.
func (o *OptAPIParsingBookPostReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptAPIParsingBookPostReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptAPIParsingBookPostReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptAPIParsingBookPostReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes APIParsingPageCheckPostReq as json.
func (o OptAPIParsingPageCheckPostReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes APIParsingPageCheckPostReq from json.
func (o *OptAPIParsingPageCheckPostReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptAPIParsingPageCheckPostReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptAPIParsingPageCheckPostReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptAPIParsingPageCheckPostReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes APIParsingPagePostReq as json.
func (o OptAPIParsingPagePostReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes APIParsingPagePostReq from json.
func (o *OptAPIParsingPagePostReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptAPIParsingPagePostReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptAPIParsingPagePostReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptAPIParsingPagePostReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes BookDetailsAttributesItemCode as json.
func (o OptBookDetailsAttributesItemCode) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
...
// Decode decodes BookDetailsAttributesItemCode from json.
func (o *OptBookDetailsAttributesItemCode) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptBookDetailsAttributesItemCode to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptBookDetailsAttributesItemCode) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptBookDetailsAttributesItemCode) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
